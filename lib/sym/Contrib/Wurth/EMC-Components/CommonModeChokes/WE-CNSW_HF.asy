...
SYMATTR Description SMT Common Mode Line Filter (high frequency) // After inserting, right-click on the symbol to select the part number.
SYMATTR SpiceModel 0805_744233121_120ohm
SYMATTR Prefix X
SYMATTR InstName L
SYMATTR ModelFile Contrib/Wurth/WE-CNSW_HF.lib
PIN -96 -48 BOTTOM 8
PINATTR PinName 4
