...
SYMATTR Description SMT Common Mode Power Line Choke // After inserting, right-click on the symbol to select the part number.
SYMATTR SpiceModel SH_74466340007_0.7m
SYMATTR Prefix X
SYMATTR InstName L
SYMATTR ModelFile Contrib/Wurth/WE-LF_SMD.lib
PIN -96 -48 BOTTOM 8
PINATTR PinName 4
