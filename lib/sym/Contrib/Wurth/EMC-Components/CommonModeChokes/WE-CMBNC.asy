...
SYMATTR Description Common Mode Power Line Choke Nanocrystalline // After inserting, right-click on the symbol to select the part number.
SYMATTR SpiceModel XS_7448010911_11m
SYMATTR Prefix X
SYMATTR InstName L
SYMATTR ModelFile Contrib/Wurth/WE-CMBNC.lib
PIN -96 -48 BOTTOM 8
PINATTR PinName 1
