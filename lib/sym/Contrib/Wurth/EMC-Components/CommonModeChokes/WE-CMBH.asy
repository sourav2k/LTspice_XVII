...
SYMATTR Description Common Mode Power Line Choke (Horizontal) // After inserting, right-click on the symbol to select the part number.
SYMATTR SpiceModel L_744834101_1m
SYMATTR Prefix X
SYMATTR InstName L
SYMATTR ModelFile Contrib/Wurth/WE-CMBH.lib
PIN -96 -48 BOTTOM 8
PINATTR PinName 4
